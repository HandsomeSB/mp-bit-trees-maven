...
public class BrailleAsciiTables {
  ...
  /**
   * Converts an ASCII letter to braille.
   *
   * @param letter the letter to convert
   * @return The braille as a bit string
   */
  public static String toBraille(char letter) {
    ...
    return a2bTree.get(String.format("%8s", Integer.toBinaryString(letter)).replace(' ', '0'));
  } // toBraille(char)

  /**
   * Converts braille to ASCII character.
   *
   * @param bits the bits of braille
   ...
   * Braille to unicode.
   *
   * @param bits braille bits
   * @return unicode character in hex
   */
  ...
  /**
   * Gets the Ascii to braille table.
   *
   * @return A2B table
   */
  public static String getA2BTable() {
    return BrailleAsciiTables.A2B;
  } // getA2BTable
} // BrailleAsciiTables
